...
public class Consulta extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        Registro infoPaciente = new Registro();
        
        System.out.print(infoPaciente.pacienteArray[0]);
        ...
        System.out.println(infoPaciente.pacienteArray[0]);
        
        /*if (infoPaciente.pacienteArray[0].equals(txtNombreConsulta.getText())) {
            txaInfoPaciente.setText(infoPaciente.pacienteArray[0]);
        } else {
