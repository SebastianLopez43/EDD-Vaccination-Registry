...
public class Registro_Información extends javax.swing.JFrame {      
    ...
    // Creamos un arreglo para guardar los datos de vacunación
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        Registro registro = new Registro(); // Se crea un objeto de tipo registro
        registro.setVisible(true); // La ventana de registro se abre
        this.setVisible(false); // Esta ventana se oculta
    }//GEN-LAST:event_btnRegresarActionPerformed

    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        // Botón que llama a la función que registra la información de vacunación
    ...
    private void registrarInformacion() {   
        ...
        if (!"".equals(txtNombreInfo.getText()) && !"".equals(txtVacuna.getText()) && !"".equals(txtFecha.getText()) && !"".equals(jcbEdadVacuna.getSelectedItem()) && 
            ...
            // Se crea un objeto de tipo información del paciente
            ...
            // Se guardan los dentro del arreglo vacuna en la primera posición
            ...
            // Se manda un mensaje donde la información se registró
