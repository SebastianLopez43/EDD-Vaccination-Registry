...
public class Registro extends javax.swing.JFrame {
    ...
    // Creamos un arreglo para guardar a los usuarios (pacientes)
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(txaInfoPaciente);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        // Botón que llama a la función que registra a los pacientes
        registrarPacientes();                 
    ...
    private void btnRegresarMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarMenuActionPerformed
        Main_Menu menu = new Main_Menu(); // Se crea un objeto de tipo menú
        menu.setVisible(true); // La ventana del menú se abre
    ...
    private void btnRegistrarInformacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarInformacionActionPerformed
        Registro_Información registrarInfo = new Registro_Información(); // Se crea un objeto de tipo registro_información
        registrarInfo.setVisible(true); // La ventana de registro de información se abre
        this.setVisible(false); // Esta ventana se oculta
    ...
    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        ...
        if (!"".equals(txtNombreConsulta.getText())) {
            ...
            // En caso de no introducirse un nombre para consultar, se manda un mensaje
    ...
    private void registrarPacientes() {  
        ...
        if (!"".equals(txtNombre.getText()) && !"".equals(txtApellido.getText()) && !"".equals(jcbEdad.getSelectedItem()) && !"".equals(jcbGénero.getSelectedItem()) &&
            ...
            // Se crea un objeto de tipo paciente
            Paciente paciente = new Paciente();
                        
            // Se guardan los datos introducidos en variables de tipo String
            ...
            // Se guardan los datos dentro del arreglo paciente en la primera posición
            pacienteArray[a] = paciente.getNombre() + "\n" + paciente.getEdad() + "\n" + paciente.getGenero() + "\n" + paciente.getCurp() + "\n" + paciente.getCalle() +
                    " " + paciente.getNumCalle() + "\n" + paciente.getColonia() + "\n" + paciente.getCodPost() + "\n" + paciente.getMunicipio();

            // Se manda un mensaje donde el paciente se registró
            JOptionPane.showMessageDialog(null, "Paciente Registrado");          
            
            // Contador que aumenta cada vez que se hace un nuevo registro
            a++;                    
            ...
            // En caso de no introducir un dato, se manda un mensaje
